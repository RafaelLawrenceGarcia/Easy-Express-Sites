...
// Handles two modes:
// 1. token mode  — called from ResetConfirmPage with recovery email token
// 2. (future)    — direct reset if PlayFab ever supports it
...
export default async function handler(req, res) {
  ...
  // Call Admin/ResetUserPassword with the token from the recovery email
  try {
